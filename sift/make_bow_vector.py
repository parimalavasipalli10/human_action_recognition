...
if __name__ == "__main__":
    ...
    dataset = pickle.load(open("E:/PROJECT@12A/code/KTH-Action-Recognition-master/baseline_sift_bow_svm_individual_frame/data1/train.p", "rb"))

    dataset_bow = make_bow(dataset, clusters, tfidf)
    print("Length of dataset bow : ",len(dataset_bow))

    pickle.dump(dataset_bow, open("data1/train1_bow_75.p", "wb"))
